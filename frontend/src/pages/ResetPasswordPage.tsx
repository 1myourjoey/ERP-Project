      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/40 bg-white/90 p-6 shadow-xl backdrop-blur-xl">
        {!token ? (
          <div className="space-y-3 text-center">
            <h1 className="text-xl font-semibold text-[#0f1f3d]">재설정 링크 오류</h1>
            <p className="text-sm text-[#64748b]">토큰이 없거나 형식이 올바르지 않습니다.</p>
          ...
          <div className="space-y-3 text-center">
            <h1 className="text-xl font-semibold text-[#0f1f3d]">비밀번호가 변경되었습니다</h1>
            <p className="text-sm text-[#64748b]">새 비밀번호로 다시 로그인해 주세요.</p>
            <Link to="/login" className="primary-btn inline-flex w-full items-center justify-center">
              로그인하기
            </Link>
          </div>
          ...
          <>
            <div className="mb-4 text-center">
              ...
              <h1 className="mt-3 text-lg font-semibold text-[#0f1f3d]">비밀번호 재설정</h1>
            </div>
