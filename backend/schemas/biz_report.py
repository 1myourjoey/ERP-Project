...
class BizReportRequestUpdate(BaseModel):
    ...
    prev_operating_income: Optional[float] = None
    prev_net_income: Optional[float] = None
    doc_financial_statement: Optional[str] = None
    doc_biz_registration: Optional[str] = None
    doc_shareholder_list: Optional[str] = None
    doc_corp_registry: Optional[str] = None
    doc_insurance_cert: Optional[str] = None
    doc_credit_report: Optional[str] = None
    doc_other_changes: Optional[str] = None
    request_sent_date: Optional[date] = None
    request_deadline: Optional[date] = None
    all_docs_received_date: Optional[date] = None
    comment: Optional[str] = None
    reviewer_comment: Optional[str] = None
    risk_flag: Optional[str] = None
...
class BizReportRequestResponse(BaseModel):
    ...
    prev_operating_income: Optional[float] = None
    prev_net_income: Optional[float] = None
    doc_financial_statement: str = "not_requested"
    doc_biz_registration: str = "not_requested"
    doc_shareholder_list: str = "not_requested"
    doc_corp_registry: str = "not_requested"
    doc_insurance_cert: str = "not_requested"
    doc_credit_report: str = "not_requested"
    doc_other_changes: str = "not_requested"
    request_sent_date: Optional[date] = None
    request_deadline: Optional[date] = None
    all_docs_received_date: Optional[date] = None
    comment: Optional[str] = None
